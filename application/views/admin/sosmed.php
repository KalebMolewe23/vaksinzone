...
<section class="home-section">
    ...
    <main>
        <section class="section-p1">
            <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal_add_new"><strong><i class='bx bx-plus-circle'></i> Tambah Sosmed</strong></button></a><br><br>
            ...
            <table class="table table-bordered table-striped" id="datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <center>Nama Sosial Media</center>
                        </th>
                        <th>
                            <center>Link </center>
                        </th>
                ...
                <tbody>
                    ...
                    foreach ($sosmed as $value) { ?>
                        <tr>
                            ...
                            <td align="center"><?= $value->nama_sosmed ?></td>
                            <td align="center"><?= $value->link ?></td>
                            <td align="center"><?= $value->icon ?></td>
                            <td align="center">
                                <?php if ($value->status == 0) { ?>
                                    <span class="labels danger">Tidak Aktif</span>
                                <?php } else if ($value->status == 1) { ?>
                                    <span class="labels info">Aktif</span>
                                <?php } ?>
                            </td>
                            <td align="center">
                                <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_edit_sosmed" href="<?= base_url('admin/editsosmed/' . $value->id_sosmed) ?>"><strong><i class='bx bx-plus-circle'></i>Edit</strong></button></a><br><br>
                                <?= anchor('admin/deletesosmed/' . $value->id_sosmed, '<div class="btn btn-danger btn-sm"><i class="bx bxs-trash-alt"></i> Hapus</div>') ?>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
