...
<section class="home-section">
    ...
    <div class="home-content">
        ...
        <span class="text"><i class='bx bxs-virus'></i> Tambah Data Vaksinasi</span>
    </div>
    ...
    <main>
        ...
        <div class="container">
            ...
            <form action=<?= base_url('admin/data_vaksin') ?> method="post">
                ...
                <div class="form_group">
                    ...
                    <input class="form-control selectric" type="text" name="vaksin_gel1" id="vaksin_gel1" required />
                </div>

                <div class="form_group">
                    <label>Vaksin Gelombang 2</label>
                    <input class="form-control selectric" type="text" name="vaksin_gel2" id="vaksin_gel2" required />
                </div>

                <div class="form_group">
                    <label>Vaksin Gelombang 3</label>
                    <input class="form-control selectric" type="text" name="vaksin_gel3" id="vaksin_gel3" required />
                </div>

                <div class="form_group">
                    <input class="form-control selectric" type="hidden" name="pers_vaksin_gel1" id="pers_vaksin_gel1" required />
                </div>

                <div class="form_group">
                    <input class="form-control selectric" type="hidden" name="pers_vaksin_gel2" id="pers_vaksin_gel2" required />
                </div>

                <div class="form_group">
                    <input class="form-control selectric" type="hidden" name="pers_vaksin_gel3" id="pers_vaksin_gel3" required />
                </div>

                <div class="form_group">
                    <input class="form-control selectric" type="hidden" name="bvaksin_gel1" id="bvaksin_gel1" required />
                </div>

                <div class="form_group">
                    <input class="form-control selectric" type="hidden" name="bvaksin_gel2" id="bvaksin_gel2" required />
                </div>

                <div class="form_group">
                    <input class="form-control selectric" type="hidden" name="bvaksin_gel3" id="bvaksin_gel3" required />
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#jumlah_penduduk, #vaksin_gel1, #vaksin_gel2, #vaksin_gel3, #pers_vaksin_gel1, #pers_vaksin_gel2, #pers_vaksin_gel3, #bvaksin_gel1, #bvaksin_gel2, #bvaksin_gel3").keyup(function() {
