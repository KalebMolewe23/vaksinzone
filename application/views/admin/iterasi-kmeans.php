...
<section class="home-section">
    ...
    <div class="home-content">
        ...
        <span class="text"><i class='bx bxs-data'></i> Iterasi Lanjut K-Means</span>
    </div>
    ...
    <main>
        ...
        <a class="btn btn-primary" href="<?= base_url("admin/interasi_lanjut"); ?>"><i class='bx bx-loader-circle'></i> Proses Iterasi Selanjutnya</a></br>
        </br>

        <table id="table_data" class="table table-bordered table_hover table-striped table-responsive">
            <tr align="center">
                <td rowspan="2">No.</td>
            ...
            <?php
                ...
                $q = "insert into centroid_temp(iterasi,id_vaksin,c1,c2,c3) values(1,'" . $s->id_vaksin . "','" . $arr_c1[$no] . "', '" . $arr_c2[$no] . "','" . $arr_c3[$no] . "')";
                $this->db->query($q);
