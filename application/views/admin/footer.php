    ...
    <main>
        <section class="section-p1">
            ...
            <table class="table table-bordered table-striped" id="datatable">
                ...
                <tbody>
                    <?php $no = 1;
                    foreach ($bawah as $value) { ?>
                        <tr>
                            <td align="center"><?= $no++ ?></td>
                            <td align="center"><?= $value->address ?></td>
                            <td align="center"><?= $value->phone ?></td>
                            <td align="center"><?= $value->alamat_website ?></td>
                            <td align="center">
                                <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_edit_sosmed" href="<?= base_url('admin/editsosmed/' . $value->id_footer) ?>"><strong><i class='bx bx-plus-circle'></i>Edit</strong></button></a><br><br>
                                <?= anchor('admin/deletesosmed/' . $value->id_footer, '<div class="btn btn-danger btn-sm"><i class="bx bxs-trash-alt"></i> Hapus</div>') ?>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
